...
import Types (
  ...
  StartClusterRequest (
    ...
    epochSize,
    keysToGenerate,
    slotLength, systemStartOverride
  ),
...
startClusterHandler
  ...
  StartClusterRequest {slotLength, epochSize, keysToGenerate, systemStartOverride} = interpret $ do
    ...
    let extraConf = ExtraConfig slotLength epochSize systemStartOverride
